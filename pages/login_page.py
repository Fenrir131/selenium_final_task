...
class LoginPage(BasePage):
    ...
    def should_be_login_url(self):
        assert "login" in self.browser.current_url, "There is no 'login' substring in login url"
    ...
    def register_new_user(self, email, password):
        ...
        registration_submit_button = self.browser.find_element(*LoginPageLocators.REGISTRATION_BUTTON)
